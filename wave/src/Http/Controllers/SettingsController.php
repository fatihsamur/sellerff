...
class SettingsController extends Controller
{
    ...
    {
        if (empty($section)) {
            return redirect(route('wave.settings', 'general'));
        }
    ...
    public function profileUpdate(Request $request)
    {
        ...
        return back()->with(['message' => 'Profil Bilgileriniz Başarıyla Güncellendi.', 'message_type' => 'success']);
    }
    ...
    public function invoiceUpdate(Request $request)
    {
      ...
      'phone_number' => 'required',
        ...
        $user->update(
            [
      'billing_line1' => $request->line1,
      'billing_line2' => $request->line2,
      'billing_state' => $request->state,
      'billing_city' => $request->city,
      'billing_zip_code' => $request->zip_code,
      'billing_phone_number' => $request->phone_number,
    ]
        );

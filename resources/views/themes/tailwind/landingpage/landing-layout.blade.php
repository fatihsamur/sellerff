...
<head>
  ...
  <title>
    Sellerfulfilment - Amazon Seller Automation
  </title>
...
<body>
          ...
          <div class="w-full px-4 md:w-2/3 lg:w-1/2">
            <div class="my-1">
              <div class="-mx-3 flex items-center justify-center md:justify-start">
                ...
                <a href="{{ url('/landing-terms-of-services') }}" class="px-3 text-base text-[#f3f4fe] hover:text-primary">
          ...
          <div class="hidden w-full px-4 md:w-1/3 lg:w-1/2">
            <div class="my-1 flex justify-center md:justify-end">
              <p class="text-base text-[#f3f4fe]">
                ...
                <a href="https://solnerasoftware.com/" rel="nofollow noopner" target="_blank" class="text-primary hover:underline">
                  Solnera Software
                </a>
              </p>
            </div>
  ...
  <!-- ====== Back To Top Start -->
  <a href="javascript:void(0)" class="back-to-top fixed bottom-8   z-[999] hidden h-10 w-10 items-center justify-center rounded-md bg-primary text-white shadow-md transition duration-300 ease-in-out hover:bg-dark">

...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6">
            ...
            <div class="intro-y box mt-5">
                <div class="relative flex items-center p-5">
                    ...
                    <div class="ml-4 mr-auto">
                        ...
                        <div class="text-gray-600">Bakiye : {{ auth()->user()->balance }} $</div>
                        <div class="text-gray-600">Email : {{ auth()->user()->email }}</div>
                        <div class="text-gray-600">Adres : {{ auth()->user()->shipping_address_line() }}
                            {{ setting('site.warehouse_address2') }}</div>

                    </div>
                </div>
                <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                    <div class="relative flex items-center p-5">
                        <div class="font-medium text-base">Ayarlar</div>
                    </div>
                    <a class="flex items-center dark:text-theme-10 @if (Request::is('settings/general')) font-medium text-theme-1 @endif "
                        href="{{ url('settings/general') }}"> <i data-feather="map-pin" class="w-4 h-4 mr-2"></i>
                        Gönderi Adresim </a>
                    <a class="flex items-center mt-5 @if (Request::is('settings/profile')) font-medium text-theme-1 @endif"
                        href="{{ url('settings/profile') }}"> <i data-feather="user" class="w-4 h-4 mr-2"></i>
                        Profil
                        Bilgilerim</a>
                    <a class="flex items-center mt-5 @if (Request::is('settings/security')) font-medium text-theme-1 @endif"
                        href="{{ url('settings/security') }}"> <i data-feather="lock" class="w-4 h-4 mr-2"></i>
                        Güvenlik
                        Ayarları </a>
                    <a class="flex items-center mt-5 @if (Request::is('settings/logs')) font-medium text-theme-1 @endif"
                ...
                <div class="p-5 border-t border-gray-200 dark:border-dark-5">
                    <div class="relative flex items-center p-5">
                        <div class="font-medium text-base">Faturandırma</div>
                    </div>
                    <a class="flex items-center @if (Request::is('settings/plans')) font-medium text-theme-1 @endif "
                        href="{{ url('settings/plans') }}"> <i data-feather="credit-card" class="w-4 h-4 mr-2"></i>
                        Planlar
                    </a>
                    <a class="flex items-center mt-5 @if (Request::is('settings/subscription')) font-medium text-theme-1 @endif "
                        href="{{ url('settings/subscription') }}"> <i data-feather="sliders" class="w-4 h-4 mr-2"></i>
                        Abonelik </a>
                    <a class="flex items-center mt-5 @if (Request::is('settings/invoices')) font-medium text-theme-1 @endif "
                        href="{{ url('settings/invoices') }}"> <i data-feather="clipboard" class="w-4 h-4 mr-2"></i>
                        Faturalar </a>
                    <a class="flex items-center mt-5 @if (Request::is('settings/invoiceaddress')) font-medium text-theme-1 @endif "
                        href="{{ url('settings/invoiceaddress') }}"> <i data-feather="archive"
        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9 pt-5">

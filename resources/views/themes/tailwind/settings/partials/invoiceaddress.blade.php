                  ...
                  <div class="grid grid-cols-12 gap-x-5">
                      <div class="col-span-12 2xl:col-span-12">
                          <div class="p-5 rounded-lg flex flex-col">
                              <form class="flex flex-col" action="{{ route('wave.settings.invoiceaddress.post') }}"
                                  method="POST">
                                  <div class="mt-5">
                                      <label for="line1"
                                      ...
                                      <div class="mt-1 rounded-md shadow-sm">
                                          <input value="{{ $user->billing_line1 }}" id="line1" type="text" name="line1"
                                  ...
                                  <div class="mt-5">
                                      <label for="line2"
                                          ...
                                          Satır 2</label>
                                      <div class="mt-1 rounded-md shadow-sm">
                                          <input value="{{ $user->billing_line2 }}" id="line2" type="text" name="line2"
                                  ...
                                  <div class="mt-5">
                                      ...
                                      <div class="mt-1 rounded-md shadow-sm">
                                          <input value="{{ $user->billing_state }}" id="state" type="text" name="state"
                                  ...
                                  <div class="mt-5">
                                      ...
                                      <div class="mt-1 rounded-md shadow-sm">
                                          <input value="{{ $user->billing_city }}" id="city" type="text" name="city"
                                  ...
                                  <div class="mt-5">
                                      ...
                                      <div class="mt-1 rounded-md shadow-sm">
                                          <input value="{{ $user->billing_zip_code }}" id="zip_code" type="text"
                                  ...
                                  <div class="mt-5">
                                      <label for="phone_number"
                                          ...
                                          Telefonu</label>
                                      <div class="mt-1 rounded-md shadow-sm">
                                          <input value="{{ $user->billing_phone_number }}" id="phone_number" type="text"

    ...
    <tr>
        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
            ...
            <div
                ...
                {{$order_number}} 'nolu Siparişiniz depoda işlenmeye başlanmıştır.<br></br>
                FBA hazırlık ve Etiketleme işlemleri bittiğinde  siparişinizin koli etiketleri gönderilmesi istenecektir . <br></br>
                Teşekkür ederiz.<br></br>

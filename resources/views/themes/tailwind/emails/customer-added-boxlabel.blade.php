    ...
    <tr>
        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
            ...
            <div
                ...
                Müşteri {{$order_id}} Order Idli Siparişine Box Label Ekledi
            </div>
    ...
    <tr>
        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
            ...
            <div
                ...
                Siparişin Kutu etiketleri müşteri tarafından yüklenmiştir. Depo görevlisinin işlem yapması gerekmektedir.<br></br>
            </div>

			...
			<div class="flex flex-col justify-between w-full mt-2">
				<div class="flex flex-col items-center">
					...
					<div class="mt-3 text-center sm:ml-4">
						...
						<div class="mt-1">
							<p class="text-sm leading-5 text-gray-500">Aboneliğinizi <span x-text="$store.plan_modal.plan_name"></span> plana taşımak istediğinize emin misiniz ?</p>
						</div>
					</div>
				</div>

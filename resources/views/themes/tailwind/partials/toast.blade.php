<div style="z-index: 9999999;" class="fixed inset-0 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6 sm:items-start sm:justify-end">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1 w-0 pl-3.5 ml-1 border-l border-gray-100">
                        <p class="text-sm font-medium leading-5 text-gray-900">
                            <template x-if="$store.toast.type == 'info'"><span>Dikkat</span></template>
                            <template x-if="$store.toast.type == 'warning'"><span>Uyarı</span></template>
                            <template x-if="$store.toast.type == 'success'"><span>Başarılı</span></template>
                            <template x-if="$store.toast.type == 'danger'"><span>Birşeyler Yanlış Gitti</span></template>
                        </p>

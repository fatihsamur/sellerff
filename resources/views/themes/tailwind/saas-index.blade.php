<div class="items-center flex flex-col justify-between lg:flex-row md:px-12 lg:px-20 p-4 dark:bg-gray-800 transition duration-500">
  <div class="text-container pl-10  md:mt-10 md:w-1/2">
    ...
    <h1 class="text-4xl md:text-4xl text-black font-bold dark:text-white tracking-normal leading-10 mt-2"><span class="text-wave-500">Çok Yönlü ve Stratejik </span>Ara Depo ile Ticaretinizi Hızlandırın</h1>
    ...
    <div class="buttons-container flex justify-center md:justify-start space-x-2 md:space-x-4 text-white dark:text-white my-12">
      <a href="{{url('pricing')}}" class="font-semibold rounded-md text-lg md:text-base bg-wave-500 px-4 py-2 md:px-8 md:py-4 cursor-pointer transform transition duration-200 hover:shadow-xl hover:-translate-y-1">
        <span class="hidden lg:inline-block">Browse</span> Fiyatlarımız </a>

      <a href="{{url('register')}}" class=" ml-3 font-semibold rounded-md text-lg md:text-base bg-red-500 px-4 py-2 md:px-8 md:py-4 cursor-pointer transform transition duration-200 hover:shadow-xl hover:-translate-y-1">
  ...
  <div class="hidden lg:block ml-6 mr-6 image-container ml-10 md:w-1/2 md:mt-10 md:-mr-20">
    <img class=" rounded-lg mt-12" src="{{ asset('themes/' . $theme->folder . '/images/saas-images/hero.jpg') }}" alt="">
  </div>
</div>
    ...
    <div class="flex flex-wrap items-center">
      ...
      <div class="w-full lg:w-1/2">
        <div class="mx-3 lg:mr-0 lg:ml-3 wow fadeInRight" data-wow-delay="0.3s">
          ...
          <img src="{{ asset('themes/' . $theme->folder . '/images/saas-images/feature/img-1.svg') }}" alt="">
    ...
    <div class="flex flex-wrap justify-center items-center">
      <div class="w-1/2 md:w-1/4 lg:w-1/4">
        <div class="m-3 wow fadeInUp" data-wow-delay="0.3s">
          <img class="" src="{{ asset('themes/' . $theme->folder . '/images/saas-images/clients/img1.png') }}" alt="">

        </div>
      </div>
      <div class="w-1/2 md:w-1/4 lg:w-1/4">
        <div class="m-3 wow fadeInUp" data-wow-delay="0.6s">
          <img class="" src="{{ asset('themes/' . $theme->folder . '/images/saas-images/clients/img2.png') }}" alt="">

        </div>
      </div>
      <div class="w-1/2 md:w-1/4 lg:w-1/4">
        <div class="m-3 wow fadeInUp" data-wow-delay="0.9s">
          <img class="" src="{{ asset('themes/' . $theme->folder . '/images/saas-images/clients/img4.png') }}" alt="">

        </div>
      </div>
      <div class="w-1/2 md:w-1/4 lg:w-1/4">
        <div class="m-3 wow fadeInUp" data-wow-delay="1.2s">
          <img class="" src="{{ asset('themes/' . $theme->folder . '/images/saas-images/clients/img3.png') }}" alt="">

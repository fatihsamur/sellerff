...
">
    ...
    <div id="fullscreenLoader" style="z-index: 5000000;"
        class="fixed inset-0 top-0 left-0 flex flex-col items-center justify-center hidden   w-full h-full bg-gray-900 opacity-50">

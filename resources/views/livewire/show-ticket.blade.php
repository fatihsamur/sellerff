                ...
                <div class="h-full flex flex-col">
                    <div class="flex flex-col sm:flex-row border-b border-gray-200 dark:border-dark-5 px-5 py-4">
                        <div class="flex items-center">
                            <div class="mr-auto">
                                <div class="font-medium text-base">Sellerfulfilment Yetkilisi</div>
                            </div>
                        </div>
                        <div
                    ...
                    <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
                        @forelse ($ticket->conversations as $conversation)
                            ...
                            @if ($conversation->user->role_id == 1 || $conversation->user->role_id == 7)
                                <div class="chat__box__text-box flex items-end float-left mb-4">
                                    <div
                                        class="bg-gray-200 dark:bg-dark-5 px-4 py-3 text-gray-700 dark:text-gray-300 rounded-r-md rounded-t-md">
                                        {{ $conversation->message }}
                                        <div class="mt-1 text-xs text-gray-600">{{ $conversation->created_at }}</div>
                                    </div>
                            ...
                            @else
                                ...
                                <div class="chat__box__text-box flex items-end float-right mb-4">
                                    ...
                                    <div class="bg-theme-1 px-4 py-3 text-white rounded-l-md rounded-t-md">
                                        {{ $conversation->message }}
                                        <div class="mt-1 text-xs text-theme-21">{{ $conversation->created_at }}</div>
                                    </div>
                    ...
                    <div class="pt-4 pb-10 sm:py-4 flex items-center border-t border-gray-200 dark:border-dark-5">
                        <textarea class="chat__box__input form-control dark:bg-dark-3 h-16 resize-none border-transparent px-5 py-3 shadow-none focus:ring-0"
                            rows="1" placeholder="Mesajınız..."></textarea>
                                                ...
                                                <div id="history" class="h-full tab-pane" role="tabpanel"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="grid grid-cols-8 text-2xl">
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">😀</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">😁</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">😂</button>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="grid grid-cols-8 text-2xl">
                                                            ...
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">😚</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">☺️</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🙂</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🤗</button>
                                                            ...
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">👵</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">👨&zwj;⚕️</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">👩&zwj;⚕️</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">👨&zwj;🎓</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">👩&zwj;🎓</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">👨&zwj;🏫</button>
                                                            ...
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🕵️</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🕵️&zwj;♂️</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🕵️&zwj;♀️</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">💂</button>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="grid grid-cols-8 text-2xl">
                                                            ...
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">™️</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">#️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">*️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">0️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">1️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">2️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">3️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">4️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">5️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">6️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">7️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">8️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">9️⃣</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🔟</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">💯</button>
                                                            ...
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🆓</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">ℹ️</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🆔</button>
                                                            <button
                                                                class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">Ⓜ️</button>
